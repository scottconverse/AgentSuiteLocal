...
// C-3: RECOMMENDED list now sourced from data.js (3 models: gemma4:e2b, gemma4:e4b, gemma4:26b-moe)
...
describe("ModelView", () => {
  ...
  it("renders all 3 recommended models from data.js", async () => {
    ...
    expect(screen.getAllByText(/gemma4:26b-moe/).length).toBeGreaterThanOrEqual(1);
  });
